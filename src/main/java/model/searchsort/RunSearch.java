...
public class RunSearch implements ComicSearcher{
    ...
    /*
    Checks if there is a run within a list of comics (of the same series title and volume)
     */
    private boolean isRun(List<Comic> comics){
        if (comics.size() < 12){ // Change to 12 before full release
            return false;
        }
